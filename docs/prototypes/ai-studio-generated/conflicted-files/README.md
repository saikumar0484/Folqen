...
## Local Setup
=======
Folqen is a secure AI Creator Command Center for an Urban Legends / Mystery / Folklore brand.
...
Do not enable public publishing, paid tools, or browser automation without explicit approval-gated implementation.
>>>>>>> theirs
