...
export const appRoutes: RouteConfig[] = [
  ...
  },
  {
    ...
    description: "Review agent commands, approvals, setting changes, blocked actions, and handoff checkpoints.",
    status: "Mock",
    stats: [
      { label: "Events", value: "24", hint: "Mock entries", tone: "premium" },
      { label: "Blocked", value: "6", hint: "Safety gates", tone: "safe" },
      { label: "Secrets", value: "Hidden", hint: "No frontend exposure", tone: "safe" },
    ],
    panels: [
      { title: "Agent commands", description: "Track what the agent was asked to do and why it was allowed or blocked.", status: "Mock" },
      { title: "Approval logs", description: "Approval decisions will be immutable audit entries later.", status: "Mock" },
      { title: "Security events", description: "Sensitive changes require server-side checks and audit logging.", status: "Needs approval" },
    ],
    actions: ["Filter events", "Export log", "Open risk log"],
  },
  {
    id: "workflows",
    href: "/workflows",
