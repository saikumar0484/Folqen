    ...
    <div className="section-space pb-8">
      <Card className="panel-soft">
        <CardContent className="py-5">
          <h1 className="font-display text-2xl font-semibold tracking-[-0.03em]">Brand</h1>
          <p className="mt-2 max-w-3xl text-sm leading-7 text-muted-foreground">
            Brand guardrails are defined through onboarding and your mission objective, not prefilled demo presets.
          </p>
        </CardContent>
      </Card>
