      ...
      <header className="sticky top-0 z-40 border-b border-white/10 bg-[#080d14]/80 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center gap-2">
            <Link href="/join-beta" className="inline-flex items-center gap-2 rounded-xl border border-white/12 bg-white/[0.04] px-4 py-2 text-sm font-semibold transition hover:bg-white/[0.08]">
              Sign Up
            </Link>
            <Link href="/login?next=%2Fdashboard" className="inline-flex items-center gap-2 rounded-xl bg-neon px-4 py-2 text-sm font-semibold text-black transition hover:brightness-110">
              Open App
            </Link>
          </div>
        </div>
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 pb-20 pt-16 sm:px-6 md:pt-24 lg:grid-cols-[1.06fr_0.94fr]">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-white/12 bg-white/[0.05] px-3 py-1.5">
              ...
              <span className="font-mono text-[10px] uppercase tracking-[0.2em] text-muted-foreground">Creator operating system / invite-only beta</span>
            </div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/login?next=%2Fdashboard" className="inline-flex items-center gap-2 rounded-xl bg-neon px-5 py-3 text-sm font-semibold text-black transition hover:brightness-110">
                Enter Folqen
      ...
      <footer className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
        <div className="panel rounded-2xl p-6">
          <div className="grid gap-6 md:grid-cols-[1fr_auto] md:items-center">
            ...
            <Link href="/login?next=%2Fdashboard" className="inline-flex items-center justify-center gap-2 rounded-xl bg-neon px-5 py-3 text-sm font-semibold text-black transition hover:brightness-110">
              Open App
              <ArrowRight className="h-4 w-4" />
            </Link>
          </div>
